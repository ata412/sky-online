  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <div className="bg-gold-50 dark:bg-navy-800 border border-gold-200 dark:border-navy-700 rounded-2xl p-6">
          <h3 className="font-bold text-navy-900 dark:text-white mb-2">{t('register.hasReferrer')}</h3>
      ...
      <div className="lg:col-span-3">
        {status?.type === 'success' ? (
          <div className="bg-white dark:bg-navy-900 rounded-2xl shadow-md p-8 text-center">
            <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-5">
              <CheckCircle size={40} className="text-green-500" />
            </div>
            <h2 className="text-2xl font-bold text-navy-900 dark:text-white mb-2">{t('register.successTitle')}</h2>
            <p className="text-gray-500 dark:text-gray-400 mb-6">
              {t('register.successWelcome', { firstName: status.member.first_name, lastName: status.member.last_name })}
            </p>

            <div className="bg-gray-50 dark:bg-navy-800 rounded-xl p-5 mb-6">
              <p className="text-xs text-gray-400 mb-1">{t('register.memberCode')}</p>
              <div className="flex items-center justify-center gap-3">
                <span className="text-3xl font-bold text-navy-900 dark:text-white tracking-widest">
            ...
            <div className="flex gap-3 justify-center">
              <Link href="/" className="btn-gold">{t('register.backHome')}</Link>
              <button
          ...
          <div className="bg-white dark:bg-navy-900 rounded-2xl shadow-md p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-gold-100 dark:bg-navy-800 rounded-xl flex items-center justify-center">
                <UserPlus size={20} className="text-gold-600 dark:text-gold-400" />
              </div>
              <h2 className="text-2xl font-bold text-navy-900 dark:text-white">{t('register.fillInfo')}</h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {/* Name */}
              <div>
                <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-3">{t('register.personalInfo')}</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-200 dark:border-navy-700 dark:bg-navy-800 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 text-sm"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
              ...
              {/* Contact */}
              <div>
                <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-3">{t('register.contactInfo')}</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
              ...
              {/* Password */}
              <div>
                <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-3">{t('register.passwordSection')}</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 pr-10 border border-gray-200 dark:border-navy-700 dark:bg-navy-800 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 text-sm"
                      />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full px-4 py-3 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 text-sm dark:bg-navy-800 dark:text-white ${
                          form.confirm_password && form.confirm_password !== form.password
                            ? 'border-red-300 bg-red-50 dark:bg-red-950' : 'border-gray-200 dark:border-navy-700'
                        }`}
                      />
              ...
              {/* Optional Info */}
              <div>
                <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-3">{t('register.optionalInfo')}</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{t('register.birthDate')}</label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{t('register.province')}</label>
                    <select
                      name="province" value={form.province} onChange={handleChange}
                      className="w-full px-4 py-3 border border-gray-200 dark:border-navy-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 text-sm bg-white dark:bg-navy-800 dark:text-white"
                    >
                ...
                <div className="mb-4">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{t('register.address')}</label>
                  <textarea
                    name="address" value={form.address} onChange={handleChange}
                    placeholder={t('register.addressPlaceholder')}
                    rows={2}
                    className="w-full px-4 py-3 border border-gray-200 dark:border-navy-700 dark:bg-navy-800 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 text-sm resize-none"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{t('register.referrerCode')}</label>
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-200 dark:border-navy-700 dark:bg-navy-800 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 text-sm uppercase"
                  />
                </div>
              </div>
