  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
      ...
      <div className="lg:col-span-2 space-y-6">
        <div>
          <h2 className="text-2xl font-bold text-navy-900 dark:text-white mb-6">{t('contact.channels')}</h2>
          {contactItems.map(({ icon: Icon, label, value, sub }) => (
            <div key={label} className="flex gap-4 p-4 bg-gray-50 dark:bg-navy-800 rounded-xl mb-3">
              <div className="w-12 h-12 bg-gold-100 dark:bg-navy-700 rounded-xl flex items-center justify-center flex-shrink-0">
                <Icon size={20} className="text-gold-600 dark:text-gold-400" />
              </div>
              <div>
                <p className="text-xs text-gray-400 mb-0.5">{label}</p>
                <p className="font-semibold text-navy-900 dark:text-white">{value}</p>
      ...
      <div className="lg:col-span-3">
        <div className="bg-white dark:bg-navy-900 rounded-2xl shadow-md p-8">
          <h2 className="text-2xl font-bold text-navy-900 dark:text-white mb-6">{t('contact.sendMessage')}</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{t('contact.email')}</label>
              <input
                type="email"
                name="email"
                value={form.email}
